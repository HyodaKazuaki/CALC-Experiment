...
%token	ADD SUB MUL DIV MOD CR PARL PARR EXP
%type	<float_value>	expression term primary_expression parensis_expression exponential_expression literal_expression
